...
# Example metrics — replace with actual if available
st.markdown("""
- **Accuracy**: 98%
- **F1 Score**: 0.9798
""")

# Sample confusion matrix visualization — replace with real values if known
conf_matrix = [[55, 0, 0],
               [1, 54, 0],
               [0, 2, 53]]  # Replace with your actual values
